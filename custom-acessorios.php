            ...
            <div class="container">
                <div class="col-md-10 col-md-offset-1 menu-produtos-main-container">
                   <div class="col-md-10 col-sm-12 col-xs-12 menu-prdoutos-main text-center">
                       <ul>
                           <li><a class="active" href="<?php echo site_url(); ?>/acessorios">Acessórios</a></li>
...
<!--                             <?php
                            foreach($categories as $category) {
                                ...
                                $product_cat_url = get_term_link( $category->slug, 'acessorios_itens' );
                             ?>
...
<div class="row">
    <div class="container">
        <div class="col-md-10 col-md-offset-1 margin-box">
         <div class="row">
<?php
query_posts('post_type=acessorios&order=ASC&showposts=-1');
if (have_posts()) : ?>
      <?php $i = 0; ?>
