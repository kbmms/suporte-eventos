<?php
/**
 Template Name: Mesas e Aparadores
 */
...
<!--                           <li><a href="<?php echo site_url(); ?>/sousplats-e-toalha">Sousplats e Toalha</a></li>-->
                           ...
                           <li><a class="active" href="<?php echo site_url(); ?>/mesas-e-aparadores">Mesas e Aparadores</a></li>
...
<div class="row">
    <div class="container">
        <div class="col-md-10 col-md-offset-1 margin-box">
         <div class="row">
<?php
query_posts('post_type=mesas-e-aparadores&order=ASC&showposts=-1');
if (have_posts()) : ?>
      <?php $i = 0; ?>
